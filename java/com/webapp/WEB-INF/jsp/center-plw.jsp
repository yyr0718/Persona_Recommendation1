			...
			<div id="div1"
				...
				<c:forEach items="${bq}" var="bq" begin="0" varStatus="userStatus">
						...
						<c:when test="${userStatus.index<4}">
							<a class="blue3" href="https://www.baidu.com/">${bq.key1}</a>

						</c:when>
						<c:when test="${userStatus.index<7}">
							<a class="blue4" href="https://www.baidu.com/">${bq.key1}</a>

						</c:when>
						<c:when test="${userStatus.index<10}">
							<a class="blue5" href="https://www.baidu.com/">${bq.key1}</a>

						</c:when>
						<c:when test="${userStatus.index<13}">
							<a class="blue6" href="https://www.baidu.com/">${bq.key1}</a>

						</c:when>
						<c:when test="${userStatus.index<16}">
							<a class="blue7" href="https://www.baidu.com/">${bq.key1}</a>

						</c:when>
						<c:when test="${userStatus.index<41}">
							<a class="blue<%=(int) (Math.floor(Math.random() * 3))%>"
								href="https://www.baidu.com/">${bq.key1}</a>
