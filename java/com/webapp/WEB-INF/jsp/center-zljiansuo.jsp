			...
			<div class="templatemo-content-container">
				<div class="templatemo-flex-row flex-content-row">
					...
					<table
						...
						<tbody>
							<form
								action="${pageContext.request.contextPath}/center-zljiansuonum"
									...
									<tr>
										...
										<td colspan="6" align="center">
											共${pagetotal+1}页,当前第${pagenum}页 <c:if test="${pagenum-3>0}">
												<a
													href="${pageContext.request.contextPath}/center-zljiansuonum?pagenum=${pagenum-3}">${pagenum-3}</a>
											</c:if> <c:if test="${pagenum-2>0}">
												<a
													href="${pageContext.request.contextPath}/center-zljiansuonum?pagenum=${pagenum-2}">${pagenum-2}</a>
											</c:if> <c:if test="${pagenum-1>0}">
												<a
													href="${pageContext.request.contextPath}/center-zljiansuonum?pagenum=${pagenum-1}">${pagenum-1}</a>
											</c:if> <c:if test="${pagenum-1>0}">
											<a
											href="${pageContext.request.contextPath}/center-zljiansuoup">上一页</a>&nbsp;
											</c:if>
											<c:if test="${pagenum<pagetotal+1}">
											<a
											href="${pageContext.request.contextPath}/center-zljiansuodn">下一页</a>&nbsp;
											</c:if>
