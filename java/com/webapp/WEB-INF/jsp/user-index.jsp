...
//           }
        ...
        <nav class="templatemo-left-nav">          
           <ul>
            <li><a href="${pageContext.request.contextPath}/reader-zx?cert_id=${session}" class="active">
                <i class="i-font-normal"></i>个人信息</a></li>
            <li><a href="${pageContext.request.contextPath}/ciyun">
                <i class="i-font-normal"></i>用户画像</a></li>
...
<%--                       class="i-font-normal"></i>论文推荐</a></li>--%>
            <li><a href="${pageContext.request.contextPath}/user-lendinquiry">
                <i class="i-font-normal"></i>借阅历史</a></li>
            <li><a href="${pageContext.request.contextPath}/user-bookinquiry">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                <li><a href="${pageContext.request.contextPath}/booktuijian" target="_Blank" class="active">图书推荐 </a></li>
                <li><a href="${pageContext.request.contextPath}/lwtuijian" class="active">论文推荐</a></li>
