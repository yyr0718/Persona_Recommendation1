...
<%-- 							class="i-font-normal"></i>论文推荐</a></li>--%>
					...
					<li><a
						href="${pageContext.request.contextPath}/center-bookinquiry"class="active"><i
...
<!-- 							class="i-font-normal"></i>专利查询</a></li> -->
		...
		<div class="templatemo-content col-1 light-gray-bg">
			...
			<div>&nbsp;</div>
			<form action="${pageContext.request.contextPath}/center-zljiansuo">
				<div class="test" style="float: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;按专利名称或作者名字检索论文：
				</div>
				<div>
			...
			<div class="templatemo-content-container">
				<div class="templatemo-flex-row flex-content-row">
					...
					<table
						...
						<thead>
							<tr>
							<td align="center"><a href="" class="white-text templatemo-sort-by">申请号
										<span class="caret"></span>
								</a></td>
								<td align="center"><a href="" class="white-text templatemo-sort-by">专利名称
										<span class="caret"></span>
								</a></td>
								<td align="center"><a href="" class="white-text templatemo-sort-by">发明人
										<span class="caret"></span>
								</a></td>
								<td align="center"><a href="" class="white-text templatemo-sort-by">申请人
										<span class="caret"></span>
								</a></td>
								<td align="center"><a href="" class="white-text templatemo-sort-by">申请日
										<span class="caret"></span>
								</a></td>
								<td align="center"><a href="" class="white-text templatemo-sort-by">公开日
										<span class="caret"></span>
								</a></td>
						...
						<tbody>
							<form
								action="${pageContext.request.contextPath}/center-zlinquirynum"
								class="templatemo-login-form" method="post"
								enctype="multipart/form-data">
								<c:forEach items="${lwinquiry}" var="lwinquiry">
									<tr>
									<td>${lwinquiry.sqnum}</td>
										<td>${lwinquiry.title}</td>
										<td>${lwinquiry.writer}</td>
										<td>${lwinquiry.dljg}</td>
										<td>${lwinquiry.sq_day}</td>
										<td>${lwinquiry.gk_day}</td>
									...
									<tr>
										...
										<td colspan="6" align="center">
											共${pagetotal+1}页,当前第${pagenum}页 <c:if test="${pagenum-3>0}">
												<a
													href="${pageContext.request.contextPath}/center-zlinquirynum?pagenum=${pagenum-3}">${pagenum-3}</a>
											</c:if> <c:if test="${pagenum-2>0}">
												<a
													href="${pageContext.request.contextPath}/center-zlinquirynum?pagenum=${pagenum-2}">${pagenum-2}</a>
											</c:if> <c:if test="${pagenum-1>0}">
												<a
													href="${pageContext.request.contextPath}/center-zlinquirynum?pagenum=${pagenum-1}">${pagenum-1}</a>
											</c:if> <c:if test="${pagenum-1>0}">
											<a
											href="${pageContext.request.contextPath}/center-zlinquiryup">上一页</a>&nbsp;
											</c:if>
											<c:if test="${pagenum<pagetotal+1}">
											<a
											href="${pageContext.request.contextPath}/center-zlinquirydn">下一页</a>&nbsp;
											</c:if>
